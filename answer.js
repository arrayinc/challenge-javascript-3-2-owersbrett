...
function thisOldMan(){
    let myBody = ['thumb', 'shoe', 'knee', 'door', 'hive', 'sticks', 'heaven', 'pate', 'spine', 'shin'];

    for (let i = 1; i <= myBody.length; i++){
        console.log(`This old man, he played ${i}.`);
        console.log(`He played knick-knack on my ${myBody[i-1]}. With a knick-knack, paddy-whack, Give your dog a bone.`);
